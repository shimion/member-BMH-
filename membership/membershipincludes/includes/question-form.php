...
<h3 style="text-align: center; margin: 20px 0px; text-shadow: 0px 3px 10px rgb(0, 0, 0);"><?php _e( 'Property Information', 'membership' ) ?></h3>
    <li>
	...
	<div class="full-length-width"> 
		...
		<div class="radio-outerbox">
			...
			<div class="roundedOnecheck">
				Retirement
				<input type="checkbox" name="boarding_provided[]" id="customcbutton6" value="Retirement">
...
<!---  2nd part  ---->	
	<div class="full-length-width"> 
		...
		<div class="radio-outerbox">
			<div class="roundedOnecheck">
				English
				<input type="checkbox" name="discipline[]" id="customcbutton12" value="English">
				<label for="customcbutton12"></label>
			</div>
			<div class="roundedOnecheck">
				English Pleasure
				<input type="checkbox" name="discipline[]" id="customcbutton122" value="English Pleasure">
				<label for="customcbutton122"></label>
			</div>
			<div class="roundedOnecheck">
				Western
			...
			<div class="roundedOnecheck">
				Eventing
				<input type="checkbox" name="discipline[]" id="customcbutton1232" value="Eventing">
				<label for="customcbutton1232"></label>
			</div>
			<div class="roundedOnecheck">
				Polo and Polocrosse
				<input type="checkbox" name="discipline[]" id="customcbutton1112" value="Polo and Polocrosse">
				<label for="customcbutton1112"></label>
			</div>
			<div class="roundedOnecheck">
				Gymkhana Events
				<input type="checkbox" name="discipline[]" id="customcbutton1222" value="Gymkhana Events">
				<label for="customcbutton1222"></label>
			</div>
			<div class="roundedOnecheck">
				Field/Foxhunting
				<input type="checkbox" name="discipline[]" id="customcbutton1332" value="Field/Foxhunting">
				<label for="customcbutton1332"></label>
			</div>
			<div class="roundedOnecheck">
				Harness Racing
				<input type="checkbox" name="discipline[]" id="customcbutton1442" value="Harness Racing">
				<label for="customcbutton1442"></label>
			</div>
			<div class="roundedOnecheck">
				Racing
				<input type="checkbox" name="discipline[]" id="customcbutton1552" value="Racing">
				<label for="customcbutton1552"></label>
			</div>
			<div class="roundedOnecheck">
				Not Discipline Specific
				<input type="checkbox" name="discipline[]" id="customcbutton101" value="Not Discipline Specific">
				<label for="customcbutton101"></label>
			</div>
			<div class="roundedOnecheck">
				Other
				<input type="checkbox" name="discipline[]" id="customcbutton102" value="Other">
				<label for="customcbutton102"></label>
			</div>
		</div>
	</div>
<!---  3rd part  ---->	
...
<!---  4rth part  ---->	
	<div class="full-length-width"> 
		...
		<div class="radio-outerbox">
			...
			<div class="roundedOne">
				4H
				<input type="radio" name="boarderpopulation" id="customcbutton20" value="4H">
				<label for="customcbutton20"></label>
			</div>
		</div>
	</div>
<!---  5th part  ---->	
...
<!---  8th part  ---->	
	<div class="full-length-width"> 
		...
		<div class="radio-outerbox">
			...
			<div class="roundedOne">
				yes and heated
				<input id="roundedOne106" type="radio" value="yesandheated" name="observationroom">
				<label for="roundedOne106"></label>
			</div>
			<div class="roundedOne">
				No
	...
	<div class="full-length-width"> 
		...
		<div class="radio-outerbox">
			...
			<div class="roundedOne">
				...
				<input id="roundedOne101" type="radio" value="Yes (Pasture board with fee)" name="grainprovided">
				<label for="roundedOne101"></label>
			</div>
			<div class="roundedOne">
				No
...
<!---  20th part  ---->	
	...
	<div class="full-length-width"> 
		...
		<div class="radio-outerbox">
			<div class="roundedOne">
				Yes & You Supply
				<input id="roundedOne34" type="radio" value="Yes & You Supply" name="wormingschedule">
				<label for="roundedOne34"></label>
			</div>
			<div class="roundedOne">
				 Yes & Farm Supplies
				<input id="roundedOne35" type="radio" value="Yes & You or Farm Supplies" name="wormingschedule">
	...
	<div class="full-length-width"> 
		...
		<div class="radio-outerbox">
			...
			<div class="roundedOne">
				...
				<input id="roundedOne83" type="radio" value="No, Except w/inclement weather" name="blanketingsheets">
